...
<%
	...
	str_EmailToList ="security@kubra.com"
	str_EmailCCList ="aleslie@kubra.com"
	str_EmailSubject ="Attempted un-authorised Access to ACID Console"
	...
	Response.Write "<table align=center><tr><td><h3>Access to this site is restricted to information security Personnel</h3></td></tr>"
	Response.Write "<tr><td><i>This access attemtp has been logged and reported."
	Response.Write "<br><br>Don't try this again. You have been warned."
	...
	str_HTML = str_HTML & "HTTP 401.3 - You are not authorized to view this page<br>"
